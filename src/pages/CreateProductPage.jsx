...
function CreateProductPage() {
  ...
  const notify = () => toast.success('Product Successfully Created');
  ...
  const createProductHandler = (e) => {
    ...
    axios.post("https://69803a5a6570ee87d50e72e0.mockapi.io/products", {
      name: productName,
      price: productPrice,
      image: productImage,
  ...
  return (
    <div className='row'>
      ...
      <div className='col-md-10'>
        <div className='p-5'>
          <h2 className='my-4'>Create a Product</h2>
          <form className='w-50' onSubmit={createProductHandler}>
            <div className="mb-3">
            ...
            <div className="mb-3">
              ...
              <button className="btn btn-primary" type="submit" disabled={ (isLoading == true) ? true: false }>
                ...
                <span role="status">Loading...</span></>) : "Create Product"
                }
              </button>
